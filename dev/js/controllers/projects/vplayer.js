var VideoPlayer = function (options) {
  ...
  try {
    ...
    _this.muted = (typeof options.muted == 'boolean') ? options.muted : true;
  ...
  _this.play = function () {
    var prm = _this.elements.video.play();
  ...
  function init () {
    ...
    _this.elements.video.setAttribute('webkit-playsinline', 'true');
    _this.elements.video.setAttribute('playsinline', 'true');
    _this.elements.video.setAttribute('muted', 'muted');
