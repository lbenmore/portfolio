core.controllers.MissileShooter = () => {
	const CONTROLS = {
	...
	const HTML = {
		gameOver: `
			<button class="modal__button modal__button--neutral" style="margin-top: 240px;" onclick="core.controllers.MissileShooter.newGame()">
	...
	class Game {
	    ...
	    if (this.isMobile()) {
				document.querySelector('section').dataset.mobile = true;
	      this.isMobile = true;
