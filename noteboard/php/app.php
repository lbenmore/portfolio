...
class DB {
  ...
  private static $username = "lisabe7";
  private static $password = "cobain612";
  private static $database = "lisabe7_noteboard_v2";

  public static $conn;

  function __construct () {
    self::$conn = new mysqli(self::$server, self::$username, self::$password, self::$database);
    return self::$conn;
  }
}
